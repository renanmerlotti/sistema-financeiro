          ...
          <form className="space-y-5">
            <div>
              ...
              <input
                ...
                className="mono w-full bg-transparent border border-neutral-800 text-white px-3 
                py-3 text-sm placeholder:text-neutral-700 focus:outline-none focus:border-neutral-600 transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
                className="mono w-full bg-transparent border border-neutral-800 text-white px-3
  py-3 text-sm placeholder:text-neutral-700 focus:outline-none focus:border-neutral-600            
  transition-colors"
              />
            </div>
            ...
            <button
              type="submit"
              className="mono w-full bg-neutral-100 hover:bg-neutral-300 text-neutral-950 py-3 text-sm 
